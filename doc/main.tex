...
\[ (N, \rho, \sigma) \in \Big\{25, 50, 75\Big\} \times \Big\{10^{-3}, 10^{-4}, 10^{-5}\Big\}
\times \Big\{1, 2, 3, 4\Big\} \]

The best result obtained an error of TODO on the training set and an error of
TODO on the test set as it is also possible to see in table \ref{tab:experiments}.
...
\begin{figure}[H]
	...
	\begin{subfigure}{.32\textwidth}
		\centering
		\includegraphics[width=1.0\linewidth]{images/MLP_E1.png}
	\end{subfigure}
	\begin{subfigure}{.32\textwidth}
		\centering
		\includegraphics[width=1.0\linewidth]{images/RBFN_E1.png}
	\end{subfigure}
	\begin{subfigure}{.32\textwidth}
		\centering
	...
	\caption{In order: the Franke's function and the functions obtained by
		...
		\ref{tab:experiments}. ANYTHING ELSE TO ADD?}
	\label{fig:plots}
\end{figure}
