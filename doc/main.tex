...
The network obtained a training error of 0.003 after 500 epochs making
500 function evaluations and 500 gradient evaluations before being
blocked by the early stopping algorithm.
The mean squared error is of 0.008 on the test set. Even if this method has not
obtained the best result it's important to notice that the computation took only
2.169s, which is a massive improvement w.r.t. the other methods.
...
in a very short period of time. Moreover, the decomposition method,
considering the high number of experiments done in the
second part, is even better in terms of computing time, obtaining similar
errors with respect to the extreme learning approach.
...
\begin{table}
	...
	\begin{tabular}{*{7}{c}}
		...
		Two Blocks RBFN & 70 & 0.25 & $10^{-5}$ & 0.003 & 0.008 & 2.169s \\
	\end{tabular}
